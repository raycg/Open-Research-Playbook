...
```mermaid
flowchart LR
    B["B — Graduating Researcher<br/>Prepare Transfer Package"]
    C["C — Responsible Incoming Student<br/>Verify and Reproduce MRR"]
    D["D — Advisor<br/>Review and Approve Departure"]
